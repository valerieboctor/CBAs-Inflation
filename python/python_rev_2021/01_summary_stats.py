...
graph_df = graph_df[['identificad', 'monthly_date', 'rem','duration', 'cba_month', 'num_workers']]
...
#Make average and median number of workers series for firms that had CBAs in may16, Jan16, and average of all firms
...
main_df =[graph_df[['identificad', 'cba_time']], graph_df[['identificad', 'cba_time']].loc['2014-06':'2016-01'],  \
...
for i in range(len(df)):
	...
	df[i] = main_df[i].merge(df[i], on = ['plidentificad', 'monthly_date'], how = 'inner')
#--------------------------------------------------------------------------------------------------------------------------
...
graph_labels= ["Full sample Jan 2011 - Dec 2017", "Pre-Shock June 2014 - Jan 2016", "Post-Shock May 2016 - Dec 2017" ]
shift_factor = [0, -.25, 0 ]
fig3 = plt.figure(figsize = (10,7))
for i in range(1,3):
